...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "nav.farm": { sw: "Ufugaji", en: "Farm" },
  "nav.crops": { sw: "Mazao", en: "Crops" },
  ...
  "inventory.stockFilters": { sw: "Chuja hifadhi", en: "Filter stock" },
  "inventory.inStock": { sw: "Iliyopo", en: "In Stock" },
  "inventory.expiryFilter": { sw: "Muda wa kuisha", en: "Expiry" },
  "inventory.allExpiry": { sw: "Muda wowote", en: "Any expiry" },
  "inventory.expiringSoon": { sw: "Inaisha muda karibuni", en: "Expiring soon" },
  "inventory.clearFilters": { sw: "Ondoa vichujio", en: "Clear filters" },
  "inventory.noMatchingProducts": { sw: "Hakuna bidhaa zinazolingana", en: "No matching products" },
  "inventory.noMatchingProductsHint": { sw: "Badilisha au ondoa vichujio ili uone bidhaa nyingine.", en: "Change or clear filters to see other products." },
  "inventory.allSuppliers": { sw: "Wasambazaji wote", en: "All suppliers" },
  "inventory.supplierFilter": { sw: "Chuja kwa msambazaji", en: "Supplier filter" },
  ...
  "orders.confirmDelivery": { sw: "Pokea stock", en: "Receive stock" },
  ...
  "auth.enterShop": { sw: "Ingia kwenye duka/biashara yako", en: "Sign in to your business" },
  "auth.yourName": { sw: "Jina lako", en: "Your name" },
  "auth.iAm": { sw: "Mimi ni", en: "I am a" },
  "auth.shopName": { sw: "Jina la duka/biashara", en: "Shop/business name" },
  ...
  "settings.shopSection": { sw: "Taarifa za duka/biashara", en: "Business Details" },
  "settings.shopName": { sw: "Jina la duka/biashara", en: "Shop/Business Name" },
  "settings.location": { sw: "Jiji / Mji", en: "City / Town" },
  "settings.district": { sw: "Mtaa / Wilaya", en: "District / Area" },
  "settings.category": { sw: "Aina ya biashara", en: "Business Category" },
  ...
  "customerOrders.completeSale": { sw: "Kamilisha mauzo", en: "Complete sale" },
  "customerOrders.paymentMethod": { sw: "Njia ya malipo", en: "Payment method" },
  "customerOrders.paymentRef": { sw: "Namba ya kumbukumbu (hiari)", en: "Payment reference (optional)" },
  "customerOrders.saleRecorded": { sw: "Mauzo yamehifadhiwa", en: "Sale recorded" },
