...
import { Barcode, ClipboardList, RefreshCw, ScanLine, Search, Tags } from "lucide-react";
...
export default function BarcodesPage() {
  ...
  const load = async () => {
    ...
    try {
      ...
      setReport(reportData); setProducts(productData.products); setScans(historyData.scans);
  ...
  return <AppShell><div className="mx-auto max-w-5xl pb-24 lg:pb-6">
    ...
    {loading && !report ? <div className="py-16 text-center text-gray-500">Loading barcodes...</div> : <>
      ...
      {tab === "labels" && <LabelComposer products={products} />}
