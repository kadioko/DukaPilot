    ...
    <div className="mx-auto max-w-5xl space-y-5 pb-24 lg:pb-8">
      <header className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-sm leading-6 text-gray-600">{sw ? "Weka pesa kwenye salio lako au zitoe kwa simu. Salio hili ni tofauti na mauzo, matumizi, na Funga Siku." : "Deposit into your balance or withdraw to a phone. This balance is separate from sales, expenses, and Daily Close."}</p>
        </div>
