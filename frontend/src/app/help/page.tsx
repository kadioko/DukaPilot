...
export default function HelpPage() {
  ...
  const faqs = [
    ...
    [lang === "sw" ? "Salio la Duka linafanyaje kazi?" : "How does Merchant Balance work?", lang === "sw" ? "Ikiwa Salio la Duka linaonekana kwenye menu yako, mmiliki pekee anaweza kuweka amana au kutoa pesa. Amana huongezwa baada ya mtandao kuthibitisha; utoaji unaonyesha makato ya DukaPilot na mtandao kabla ya uthibitisho. Salio hili si mauzo, si matumizi, si Daily Close, na haliwezi kutumika kulipia subscription. Usitume PIN kwenye DukaPilot." : "When Merchant Balance appears in your menu, only the owner can deposit or withdraw. Deposits are credited only after provider confirmation; withdrawals show both DukaPilot and provider fees before you confirm. This balance is not sales, an expense, Daily Close cash, or subscription payment. Never enter a mobile-money PIN in DukaPilot."],
