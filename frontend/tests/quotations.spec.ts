...
async function mockShell(page: Page) {
  ...
  await page.route("**/*api/quotations/settings", (route) => route.fulfill(json({ settings: { prefix: "QT", numberingFormat: "{prefix}-{number}", defaultValidityDays: 14, defaultCurrency: "TZS", defaultTaxRateBasisPoints: 0, showQuantities: true, showUnitPrices: true, showItemDiscounts: true, showSections: true, defaultDepositPercent: 50, business: { name: "Duka la Amina" } } })));
