...
async function main() {
  ...
  const shop = await prisma.shop.upsert({
    ...
    update: { isDemo: true, isCatalogPublished: false },
    create: { name: "Duka la Amina", location: "Mbagala", district: "Temeke", category: "grocery", userId: merchantUser.id, trialEndsAt: new Date(Date.now() + 14 * 24 * 60 * 60 * 1000), plan: "FREE_TRIAL", isActive: true, isDemo: true, isCatalogPublished: false },
  });
  ...
  const shop2 = await prisma.shop.upsert({
    ...
    update: { isDemo: true, isCatalogPublished: false },
    create: { name: "Salum Pharmacy", location: "Sinza", district: "Kinondoni", category: "pharmacy", userId: merchantUser2.id, trialEndsAt: new Date(Date.now() + 14 * 24 * 60 * 60 * 1000), plan: "FREE_TRIAL", isActive: true, isDemo: true, isCatalogPublished: false },
  });
  ...
  const shop3 = await prisma.shop.upsert({
    ...
    update: { isDemo: true, isCatalogPublished: false },
    create: { name: "Hassan Bar & Wines", location: "Buguruni", district: "Ilala", category: "bar", userId: merchantUser3.id, trialEndsAt: new Date(Date.now() + 14 * 24 * 60 * 60 * 1000), plan: "FREE_TRIAL", isActive: true, isDemo: true, isCatalogPublished: false },
  });
  ...
  const shop4 = await prisma.shop.upsert({
    ...
    update: { isDemo: true, isCatalogPublished: false },
    create: { name: "Fatuma Beauty Shop", location: "Tegeta", district: "Kinondoni", category: "beauty", userId: merchantUser4.id, trialEndsAt: new Date(Date.now() + 14 * 24 * 60 * 60 * 1000), plan: "FREE_TRIAL", isActive: true, isDemo: true, isCatalogPublished: false },
  });
